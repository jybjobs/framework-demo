...
public final class DemoServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<DemoRequest,
      DemoReply> getGetInfoMethod() {
    io.grpc.MethodDescriptor<DemoRequest, DemoReply> getGetInfoMethod;
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getInfo(DemoRequest request,
  ...
  public static final class DemoServiceStub
     ...
     * </pre>
     */
    public void getInfo(DemoRequest request,
                        io.grpc.stub.StreamObserver<DemoReply> responseObserver) {
  ...
  public static final class DemoServiceBlockingStub
     ...
     * </pre>
     */
    public DemoReply getInfo(DemoRequest request) {
  ...
  public static final class DemoServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<DemoReply> getInfo(
        DemoRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_INFO:
          serviceImpl.getInfo((DemoRequest) request,
              (io.grpc.stub.StreamObserver<DemoReply>) responseObserver);
          break;
        default:
